...
(defn x-template
  ...
  (let [data {:name name
    ...
    (->files data
             ...
             ["src/clj/{{sanitized}}/system/main.clj"                            (render "src/clj/notondef/system/main.clj" data)]
             ["src/clj/{{sanitized}}/system/system.clj"                          (render "src/clj/notondef/system/system.clj" data)]
             ["src/clj/{{sanitized}}/services/provided/web/server.clj"           (render "src/clj/notondef/services/provided/web/server.clj" data)]
             ["src/clj/{{sanitized}}/services/provided/web/handlers/handler.clj" (render "src/clj/notondef/services/provided/web/handlers/handler.clj" data)]

             ["src/cljs/{{sanitized}}/main.cljs"                                 (render "src/cljs/notondef/main.cljs" data)]
             ["src/cljs/{{sanitized}}/render.cljs"                               (render "src/cljs/notondef/render.cljs" data)]
             ["src/cljs/{{sanitized}}/play/re_com_play.cljs"                     (render "src/cljs/notondef/play/re_com_play.cljs" data)]
